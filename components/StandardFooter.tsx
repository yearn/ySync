...
function	Footer(): ReactElement {
	...
	return (
		<footer className={'hidden flex-row items-center py-8 mx-auto mt-auto w-full max-w-6xl md:flex'}>
			...
			<a href={'https://thegraph.com/explorer/subgraph?id=5xMSe3wTNLgFQqsAc5SCVVwT4MiRb5AogJCuSN9PjzXF&view=Overview'} target={'_blank'} className={'pr-6 text-xs hover:underline transition-colors text-neutral-500 hover:text-accent-500'} rel={'noreferrer'}>
